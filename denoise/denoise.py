...
class ConvBlock(nn.Module):
    def __init__(self, in_chnnels, out_channels, use_act=True, **kwargs):
        super().__init__()
        self.cnn = nn.Conv2d(in_chnnels, out_channels, **kwargs, bias=False, padding_mode='reflect')
...
class Generator(nn.Module):
    def __init__(self, in_channels, out_channels, features=64, num_residuals=9):
        ...
        self.initial_down = nn.Sequential(
            nn.Conv2d(in_channels, features, 7, 1, 3, bias=True, padding_mode='relect'),
        ...
        self.up2 = Block(features*16, features*4, stride=1,act='relu')
        self.up3 = Block(features*8, features*2, stride=1,act='relu')
        self.up4 = Block(features*4, features, stride=1,act='relu')
